export const homePage = {
  hero: {
    htmlDescription: `
    <h1>
      Make logic <i>landlord</i>
    </h1>
  `,
    htmlDescription2: `<p>A modern Landlords platform powered by <i>Logic</i> that changes how Landlords facilitate tenants.</p>`,
    image: [
      {
        url: "/app-images/image1.png",
        alt: "Landlord Logic",
      },
      {
        url: "/app-images/image2.png",
        alt: "Landlord Logic",
      },
      {
        url: "/app-images/image3.png",
        alt: "Landlord Logic",
      },
    ],
  },
  sectionOne: {
    htmlDescription: `
    <h2>
      Transform landlord <i>management</i>
    </h2>
  `,
    htmlDescription2: `
    <p >
  ...
  `,
    ...
    arr: [
      ...
      {
        title: "Assign a Tenant ",
        description:
          "Figma ipsum component variant main layer. Star rotate share pencil rotate comment variant asset strikethrough figma.",
        icon: "/app-images/stats-icon2.png",
      },
      {
        title: "Let The logic do the rest",
        description:
          "Figma ipsum component variant main layer. Star rotate share pencil rotate comment variant asset strikethrough figma.",
  ...
  sectionTwo: {
    arr: [
      {
        title: "Logic in 60 seconds",
        description:
          "Learn about MyLandlordlogic and how it can change the way your organization works with data.",
        icon: "/app-images/stats-icon1.png",
      },
      {
        title: "Track in one-unified space",
        description:
          "Learn about MyLandlordlogic and how it can change the way your organization works with data.",
        icon: "/app-images/stats-icon2.png",
      },
